...
function createMenuItem(vals /*Your code here*/){
    /*Your code here*/
...
*/
const chic = createMenuItem("chicken", 6, "dinner");
console.log(chic);
...
function getReviewByIndex(arr, num /*Your code here*/) {
  /*Your code here*/
...
function getLastReview(arr  /*Your code here*/) {
  /*Your code here*/
